...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
		...
		echo "</td>";
		 ...
		 echo "<td>";
		 echo "<a class='btn btn-danger' href='customers.php'><span class='glyphicon glyphicon-backward'></span><a/>";
		 echo "<a class='btn btn-primary' href='?view_id=".$view_id."&action=finished'><span class='glyphicon glyphicon-check'></span><a/>";
		 echo "</td>";
