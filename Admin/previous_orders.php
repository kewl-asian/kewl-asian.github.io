    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">DFFRNT - Admin</a>
            </div>
...
include("config.php");
	...
	if($stmt->rowCount() > 0)
	{
		...
		echo "<tr>";
		echo "<td colspan='5' align='center' style='font-size:18px;'>"."Customer Name: <span style='color:#333;'>".$user_firstname." ".$user_lastname."</span> | "."Email: <span style='color:#333;'>".$user_email."</span> | "."Contact Number: <span style='color:#333;'>".$user_contactnumber."</span> | "."Address: <span style='color:#333;'>".$user_address." </span>";
		echo "</td>";
		
		echo "<td>"."<a class='btn btn-danger' href='customers.php'><span class='glyphicon glyphicon-backward'></span><a/>";
		echo "</td>";
