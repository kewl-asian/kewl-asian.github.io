...
<body style ="background-image:url('black.jpg'); background-size:cover; background-repeat:no-repeat;>
    <div id="wrapper">
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
	 ...
	 <div class="alert alert-default" style="background-color:#333;">
                       <p style="color:aqua;text-align:center;">
                       &copy 2016 DFFRNT Clothing shop| All Rights Reserved |  Design by : TechNexus Co. 
